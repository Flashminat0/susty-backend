...
router.get("/orders/filter-orders-customer", validateToken, filterOrdersCustomer);
router.put("/orders/cancel-pending-order", validateToken, cancelPendingOrderBySeller);
router.put("/orders/cancel-onprocess-order", validateToken, cancelOnProcessOrderBySeller);
